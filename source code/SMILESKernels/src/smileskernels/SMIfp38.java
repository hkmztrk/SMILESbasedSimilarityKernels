...
/**
 ** Original SMIfp source code is used in getSMIfp function, 4 more character are added, 1 character is replaced
 * http://pubs.acs.org/doi/suppl/10.1021/ci400206h/suppl_file/ci400206h_si_001.pdf
 * 
 */
public class SMIfp38 { /* Array size 38*/
    
    
    
    public double smifp38EuclidSim(String smiles1, String smiles2) throws Exception
    {
      ...
      public double smifp38ManhattanSim(String smiles1, String smiles2) throws Exception
    {
        ...
        public double smifp38Tanimoto(String smiles1, String smiles2) throws Exception
    {
     ...
     private int[] getSMIfp(String SMILES) throws Exception { 
            ...
            int leftB=0, rightB=0; /*Directional bonds /\ */
            ...
            */ 
            ...
            int[] SMIfp = new int[38]; // added two chirals, two directional bonds and replace % with .  
            ...
            SMIfp[26] = dot; //PerCent; /*14*/  /* 1 Replaced % with . */
            ...
            SMIfp[34] = clockWise;         /* 2 Added : @@ */
            SMIfp[35] = anticlockWise;     /* 3 Added : @ */
            SMIfp[36] = rightB;             /*4 Added : / */
            SMIfp[37] = leftB;              /*5 Added : \  */
            return SMIfp; 
            } 
